...
public class MainActivity extends AppCompatActivity {
    ...
    Socket socket = null;
    String serverAddress = /*"192.168.1.127"*/"77.76.185.128";
    ...
    private class socketConnection extends AsyncTask<String, Void,Integer > {
        ...
        protected Integer doInBackground(String... strings) {
            try {
                socket = new Socket(serverAddress, 25565);
            } catch (IOException e) {
                return 1;
            }
        ...
        protected void onPostExecute(Integer a) {
            ...
            if(a==0)Toast.makeText(MainActivity.this, "Connected to Stamat", Toast.LENGTH_SHORT).show();
            else if(a==1) Toast.makeText(MainActivity.this, "FACK SOCKET", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderFB.setRotation(-90);
         sliderLR.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                ...
                new sendMessage().execute(String.valueOf("lr"+progress));
            }
        ...
        sliderFB.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progresValue, boolean fromUser) {
                ...
                new sendMessage().execute(String.valueOf("fb"+progress));
            }
        ...
        web.loadUrl("http://81.161.245.126:4430");
